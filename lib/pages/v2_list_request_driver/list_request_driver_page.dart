...
import 'package:taxi_segurito_app/pages/v2_list_request_driver/request_accept_functionality.dart';
...
class _ListRequestDriverState extends State<ListRequestDriver> {
  ...
  RequestAcceptFunctionality requestAcceptFunctionality =
      new RequestAcceptFunctionality();
  ...
  void initState() {
    ...
    requestAcceptFunctionality.initFirebase();
    requestAcceptFunctionality.idUser = '-C1vHdPbe2km7i6xKLkz';
  ...
  Widget build(BuildContext context) {
    ...
    requestAcceptFunctionality.updateStatus = ((value) {
      setState(() {
  ...
  //AlertDialog confirm request taxista
